...
INSERT INTO FlashcardSet(user_id, quizlet_set_id, name, terms_language, definitions_language)
VALUES (1, 2958, 'American Capitals', 0, 0);
...
INSERT INTO Flashcard(flashcard_set_id, term, definition, term_image_url, definition_image_url, learned, position)
VALUES (2, 'California', 'Sacramento', NULL, NULL, TRUE, 0);

INSERT INTO Flashcard(flashcard_set_id, term, definition, term_image_url, definition_image_url, learned, position)
VALUES (2, 'Arizona', 'Phoenix', NULL, NULL, FALSE, 1);

INSERT INTO Flashcard(flashcard_set_id, term, definition, term_image_url, definition_image_url, learned, position)
VALUES (3, 'Who is All Might?', 'The greatest superhero of all time', NULL, NULL, TRUE, 0);

-- To escape single quotes, you need to place another single quote in front of it
INSERT INTO Flashcard(flashcard_set_id, term, definition, term_image_url, definition_image_url, learned, position)
VALUES (3, 'What is All Might''s quirk?', 'One for all', NULL, NULL, TRUE, 1);

INSERT INTO Flashcard(flashcard_set_id, term, definition, term_image_url, definition_image_url, learned, position)
VALUES (3, 'What is the theme song of My Hero Academia?', 'You Say Run', NULL, NULL, TRUE, 2);