...
module.exports = function(app) {
	app.post('/flashcard_set/update_all_learned_statuses', async (request, response) => {
		try {
			...
			const updateQuery = 'UPDATE Flashcard SET learned = $1 WHERE flashcard_set_id = $2'
			const values = [learned, setId];
